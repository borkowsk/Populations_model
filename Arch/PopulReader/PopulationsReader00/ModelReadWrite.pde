...
void fileSelected(File selection) 
{
  if (selection == null) {
    modelName="";
    println("Folder window was closed or the user hit cancel.");
  } else {
    modelName=selection.getAbsolutePath();
    foldSelectorF=selection;
...
void folderSelected(File selection) 
{
  if (selection == null) {
    foldSelection="";
    println("File window was closed or the user hit cancel.");
  } else 
  {
    foldSelection=selection.getAbsolutePath();
    foldSelectorF=selection;
    println("User selected " + selection.getAbsolutePath());
  }
}
